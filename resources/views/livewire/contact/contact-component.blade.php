            ...
            <div class="col-xl-6">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3>Call Us</h3>
                                <p>+60 105320377 <br>+60 105320377</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title"><i class="bi bi-clock"></i></h5>
                                <h3>Open Hours</h3>
                ...
                <div class="card p-4">
                    ...
                    <form action="">
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Message" id="floatingMessage" style="height: 100px;"></textarea>
