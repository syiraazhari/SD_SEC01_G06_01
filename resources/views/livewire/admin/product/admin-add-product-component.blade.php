            ...
            <div class="col-9">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="" class="g-3" enctype="multipart/form-data" wire:submit.prevent="addProduct">
                            <div class="col-md-7">
                            ...
                            <div class="col-md-7">
                                ...
                                @if ($image)
                                    ...
                                    <img src="{{ $image->temporaryUrl() }}" width="120" alt="Product Image" style="margin-top: 10px">
                                @endif
                                @error('image')
                                        <p class="text-danger">{{ $message }}</p>
                                @enderror
